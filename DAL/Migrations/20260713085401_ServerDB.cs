    ...
    public partial class ServerDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationTables", x => x.ReservationId);
                    table.ForeignKey(
                        name: "FK_ReservationTables_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationTables_RestaurantTables_TableId",
                        column: x => x.TableId,
                        principalTable: "RestaurantTables",
                        principalColumn: "TableId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationTables_CustomerId",
                table: "ReservationTables",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservationTables_TableId_ReservedDate",
                table: "ReservationTables",
                columns: new[] { "TableId", "ReservedDate" },
                unique: true);
